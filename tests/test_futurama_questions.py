...
from models.questions import (DefaultQuestion, DefaultQuestionsLists, QuestionDict, UpdateQuestion)
...
class TestQuestions:
    ...
    def test_get_questions(self, class_questions_client: QuestionsClient):
        ...
        validate_schema(json_response, DefaultQuestionsLists.model_json_schema())
    ...
    def test_get_question(
        ...
        response = class_questions_client.get_question_api(function_question.id)
